...
//	ArrayList<T> Retrieve(Function<T, String> searchPropertyAccessor, String searchText) throws RemoteException;
//	T RetrieveSingle(Function<T, String> searchPropertyAccessor, String searchText) throws RemoteException;
//	T RetrieveSingle(String searchPropertyAccessor, String searchText) throws RemoteException;
